                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          "Search",
                          style:
                              TextStyle(color: tertiaryColor.withOpacity(0.4)),
                        )
                      ],
                    ),
                  ),
                  ...
                  children: [
                    TextButton(
                        ...
                        child: Text(
                          "RECENTLY VIEWED",
                          style:
                              TextStyle(color: tertiaryColor.withOpacity(0.8)),
                        )),
                    TextButton(
                        onPressed: () {},
                        child: Text(
                          "CLEAR",
                          style:
                              TextStyle(color: primaryColor.withOpacity(0.9)),
                        ))
                  ],
                ),
                        ...
                        child: Container(
                          ...
                          child: Row(children: [
                            const Image(
                                ...
                                width: 50,
                                image:
                                    AssetImage("assets/images/backpack.png")),
                            widthSpace,
                            Column(
                              mainAxisAlignment: MainAxisAlignment.spaceAround,
                              crossAxisAlignment: CrossAxisAlignment.start,
